...
{
    public partial class AlarmTimeEntity : INotifyPropertyChanged
    {
        ...
        private string _AlarmTimeID;
        public string AlarmTimeID
        {
            get
            {
                return _AlarmTimeID;
            ...
            {
                _AlarmTimeID = value;
                OnPropertyChanged("AlarmTimeID");
            }
        }
        #endregion
        #region Constructor
        public AlarmTimeEntity()
        { }
        public AlarmTimeEntity(AlarmTimeEntity Obj)
        {
            _W1 = Obj.W1;
            _W2 = Obj.W2;
            _W3 = Obj.W3;
