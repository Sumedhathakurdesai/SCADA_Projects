...
{
    public static class Wagon67Datalog
    {
        #region"Declaration"
        ...
        {
            ErrorLogger.LogError.ErrorLog("Wagon67Datalog DoWork() Started", DateTime.Now.ToString(), IndiSCADAGlobalLibrary.PLCCommunication.IsPLCConnected.ToString(), null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
            ...
            try
            {
                ...
                //{
                //    ErrorLogger.LogError.ErrorLog("Wagon67Datalog DoWork() getConnectionStatus IsPLCConnected==false", DateTime.Now.ToString(), IndiSCADAGlobalLibrary.PLCCommunication.IsPLCConnected.ToString(), null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);

                //    ReadWritePlcValue.doConnect();
                //}
                //ErrorLogger.LogError.ErrorLog("Wagon67Datalog DoWork() getConnectionStatus readed " + IndiSCADAGlobalLibrary.PLCCommunication.IsPLCConnected.ToString(), DateTime.Now.ToString(), "", null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
                ...
                try
                {
                    ...
                    {
                        ErrorLogger.LogError.ErrorLog("Wagon67Datalog Dowork() WagonDataLog read", DateTime.Now.ToString(), "PLC communication failed.", null, true);
                    }
                }
                catch (Exception exReadPLCTagValues)
                {
                    ErrorLogger.LogError.ErrorLog("Wagon67Datalog Dowork() WagonDataLog read", DateTime.Now.ToString(), exReadPLCTagValues.Message, null, true);
                }
            }
            catch (Exception exThreadDashBoardUpdateTrigger)
            {
                ErrorLogger.LogError.ErrorLog("Wagon67Datalog DoWork()", DateTime.Now.ToString(), exThreadDashBoardUpdateTrigger.Message, null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
            }
        }
        private static void DispatcherTickEvent(object sender, EventArgs e)
        {
            ...
            {
                ErrorLogger.LogError.ErrorLog("Wagon67Datalog DispatcherTickEvent()", DateTime.Now.ToString(), exDispatcherTickEvent.Message, null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
            }
        }
        ...
        public static string[] ReadPLCTagValue(string TaskName)
        {
            try
            {
                if (IndiSCADAGlobalLibrary.PLCCommunication.IsPLCConnected == true) ////added by SBS to avoid hanging when there is no PLC communication 
                {
                    ...
                    {
                        ErrorLogger.LogError.ErrorLog("Wagon67Datalog ReadPLCTagValue() While Writting :" + TaskName, DateTime.Now.ToString(), ex.Message, null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
                        return null;
                    }
                }
                else
                {
                    ErrorLogger.LogError.ErrorLog("Wagon67Datalog ReadPLCTagValue()" + TaskName, DateTime.Now.ToString(), "IsPLCConnected is false", null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
                    return null;
                }
            }
            catch (Exception ex)
            {
                ErrorLogger.LogError.ErrorLog("Wagon67Datalog ReadPLCTagValue() " + TaskName, DateTime.Now.ToString(), ex.Message, null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
                return null;
            }
        }
        ...
        public static void StartWagon67DataLog()
        {
            try
            {
                ReadWritePlcValue.doConnect();
