...
{
    public class NextLoadViewModel : BaseViewModel
    {
        #region"Declaration"
        ...
        public NextLoadViewModel()
        {
            ...
            {
                ErrorLogger.LogError.ErrorLog("NextLoadViewModel ()", DateTime.Now.ToString(), ex.Message, "No", true);
            }
        }
        #endregion
        ...
        private void ExitButtonCommandClick(object _commandparameters)
        {
            ...
            {
                ErrorLogger.LogError.ErrorLog("NextLoadViewModel ExitButtonCommandClick()", DateTime.Now.ToString(), exExitButtonCommandClick.Message, "No", true);
            }
        }
        private void DoWork(object Sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            {
                ErrorLogger.LogError.ErrorLog("NextLoadViewModel DoWork()", DateTime.Now.ToString(), ex.Message, null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
            }
        }
        void DispatcherTickEvent(object sender, EventArgs e)
        {
            ...
            {
                ErrorLogger.LogError.ErrorLog("NextLoadViewModel DispatcherTickEvent()", DateTime.Now.ToString(), ex.Message, null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
            }
        }
        #endregion
