...
{
    public class SystemDataViewModel : BaseViewModel
    {
        #region"Declaration"
        ...
        public SystemDataViewModel()
        {
            ...
            {
                ErrorLogger.LogError.ErrorLog("SystemDataViewModel ()", DateTime.Now.ToString(), ex.Message, "No", true);
            }
        }
        #endregion
        ...
        private void ExitButtonCommandClick(object _commandparameters)
        {
            ...
            {
                ErrorLogger.LogError.ErrorLog("SystemDataViewModel ExitButtonCommandClick()", DateTime.Now.ToString(), exExitButtonCommandClick.Message, "No", true);
            }
        }
        private void DoWork(object Sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            {
                ErrorLogger.LogError.ErrorLog("SystemDataViewModel DoWork()", DateTime.Now.ToString(), ex.Message, null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
            }
        }
        void DispatcherTickEvent(object sender, EventArgs e)
        {
            ...
            {
                ErrorLogger.LogError.ErrorLog("SystemDataViewModel DispatcherTickEvent()", DateTime.Now.ToString(), ex.Message, null, IndiSCADAGlobalLibrary.ErrorLogEnable.IsErrorLogEnable);
            }
        }
        #endregion
